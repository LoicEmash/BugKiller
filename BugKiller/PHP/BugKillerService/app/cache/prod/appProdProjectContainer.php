...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => '127.0.0.1', 'port' => 5432, 'dbname' => 'bk', 'user' => 'postgres', 'password' => 'Emash21', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\BugKiller\\DataBundle\\Entity'))), 'BugKiller\\DataBundle\\Entity');
        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('BugKillerDataBundle' => 'BugKiller\\DataBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_c18c975495ae9a1f3d5287c50bd177a0115ff777b303760ce58ff6ad6c392e7a');
        return $instance;
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\BugKiller\\DataBundle/Resources/views'), 'BugKillerData');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('4f6c45a0cef67bc16634f319e48d65eb8db92cf2');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'BugKillerDataBundle' => 'BugKiller\\DataBundle\\BugKillerDataBundle',
            ),
            ...
            'database_password' => 'Emash21',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'en',
            'secret' => '4f6c45a0cef67bc16634f319e48d65eb8db92cf2',
            ...
            'kernel.secret' => '4f6c45a0cef67bc16634f319e48d65eb8db92cf2',
