 ...
 */
class BkFio extends \BugKiller\DataBundle\Entity\BkFio implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'bkStoryId', 'name', 'ext', 'content', 'bkStory');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BkFio $proxy) {
    ...
    public function setExt($value)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setExt', array($value));

        return parent::setExt($value);
    }
