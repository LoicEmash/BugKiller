describe('BugKiller.view.account.Account', function() {
    ...
    beforeEach(function() {
        ...
        view = Ext.create('BugKiller.view.account.Account', {
    ...
    it('should inherit from Ext.window.Window', function() {
        console.log(view);
        expect(view.isXType('Ext.window.Window')).toEqual(true);
    });
