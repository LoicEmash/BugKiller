...
folder are mapped to the application's root namespace, 'BugKiller'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'BugKiller' in the same way
as `"BugKiller/sass/src"`.
