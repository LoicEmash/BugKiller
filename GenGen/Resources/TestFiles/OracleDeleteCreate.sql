-- Supression des utilisateurs du schéma cadix
DROP USER cadix_user_consult CASCADE;
DROP USER cadix_user_admin CASCADE;

-- Supression des roles du schéma cadix
DROP ROLE cadix_role_consult;
DROP ROLE cadix_role_admin;

-- Supression du schéma cadix
DROP USER cadix CASCADE;
...
-- Création de la contrainte devis_prevision__previsiondetailtechnique de la table devis_previsiondetail qui référence la table devis_prevision
ALTER TABLE cadix.devis_previsiondetail ADD CONSTRAINT devis_prevision__previsiondetailtechnique FOREIGN KEY   (devis_prevision__id_prevision) REFERENCES cadix.devis_prevision (id_prevision);

-- Création de la contrainte devis_previsiondetail_technique de la table devis_previsiondetail qui référence la table devis_technique
ALTER TABLE cadix.devis_previsiondetail ADD CONSTRAINT devis_previsiondetail_technique FOREIGN KEY   (devis_technique__id_technique) REFERENCES cadix.devis_technique (id_technique);

-- Création de la contrainte devis_previsiondetail__bordereauprix de la table devis_previsiondetail qui référence la table devis_bordereau
ALTER TABLE cadix.devis_previsiondetail ADD CONSTRAINT devis_previsiondetail__bordereauprix FOREIGN KEY   (devis_bordereau__id_bordereau) REFERENCES cadix.devis_bordereau (id_bordereau);
